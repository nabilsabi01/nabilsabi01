...
### 💡 Frontend
- **Frameworks:** React.js, Angular 17
- **Styling:** Tailwind CSS, Bootstrap, CSS3
- **State Management:** Context API (React), RxJS, NgRx (Angular)
- **Security:** Token Interceptors, Route Guards

### 🖥️ Backend
- **Frameworks:** Spring Boot 3, Spring Security 6, Spring Data JPA
- **Authentication & Authorization:** JWT, Enum-based Role Access
- **Testing:** JUnit 5, Mockito
- **Best Practices:** OOP, SOLID, DTO, MapStruct, Clean Architecture

---

## 🚀 Featured Projects

### 🏘️ Real Estate Rental Platform *(Full Stack App)*
**Stack:** Angular 17, Spring Boot 3.3.2, Spring Security 6.3.1  
- Role-based access with JWT  
- Group rental & centralized property listings  
- CI/CD & Dockerized backend  

### 🎟️ Hello-Events
**Stack:** Angular 17, Spring Boot 3.3.2, Docker  
- Admin dashboard and booking management  
- Contact form & user authentication  
- Containerized with Docker

### 🖥️ IT Support App – *Challenge Project*
**Stack:** Angular 16, Spring Boot, PostgreSQL  
- Ticket creation and user access levels  
- Admin resource management dashboard  
- Developed in under 7 days

### 🎬 Cinema Management System
**Stack:** JEE, Hibernate  
- Movie catalog with user login system  
- JSP/Servlet architecture  
- UML and MVC patterns implemented

---

## 🌐 Connect With Me

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/nabilsabi)  
...
- 💼 Full Stack Developer with a passion for clean, modern UI and secure, scalable backend systems  
